...
@Entity
class Project(
    @ManyToOne @JoinColumn(name = "customer_id", nullable = false) var customer: Customer,
    @ManyToOne @JoinColumn(name = "employee_id", nullable = false) var managingEmployee: Employee,
