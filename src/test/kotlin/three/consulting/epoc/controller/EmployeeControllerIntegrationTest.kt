...
class EmployeeControllerIntegrationTest : ControllerIntegrationTest() {
    ...
    @Test
    fun `update employee return 200`() {
    ...
    @Test
    fun `update employee without name return 400`() {
    ...
    @Test
    fun `delete employee return 204`() {
        val response = restTemplate.exchange(
            URI("/employee/1"),
            HttpMethod.DELETE,
            null,
    ...
    fun `delete without path id return 400`() {
        ...
        Assertions.assertThat(response.statusCode).isEqualTo(HttpStatus.METHOD_NOT_ALLOWED)
    }
}
